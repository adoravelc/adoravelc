              ...
              -->
                    ...
                    <div class="-mr-2 flex md:hidden">
                        ...
                        <button type="button" @click="open = ! open"
                            ...
                            <svg :class="{'block': open, 'hidden': !open}"
            ...
            <div x-show="open" class="md:hidden" id="mobile-menu">
                ...
                <div class="border-t border-gray-700 pt-4 pb-3">
                    <div class="flex items-center px-5">
                        ...
                        <div class="ml-3">
                            <div class="text-base/5 font-medium text-white">Chavel Aiko Ratu</div>
                            <div class="text-sm font-medium text-gray-400">chavelratu@gmail.com</div>
                        </div>
                        <!-- <button type="button"
